...
def greedy_initial1(task_count):
    st=time.time()
    ...
    return np.array(df_unique_trip),np.array(eps_matrix),np.array(kai_matrix),totalCost,time.time()-st
...
if __name__ == '__main__':
    df_unique_trip,eps_matrix,kai_matrix, totalCost = greedy_initial1(1)
