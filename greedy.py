...
def greedy_initial(filepath):
	...
	return unique_trips,eps_matrix,kai_matrix


if __name__ == '__main__':
	unique_trips,eps_matrix,kai_matrix = greedy_initial('./split_data/task1.txt')
	print("number of unique_trips:",len(unique_trips),'\n')
	print("unique_trips:",unique_trips,'\n')
